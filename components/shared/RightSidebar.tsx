...
const RightSidebar = () => {
	...
	return (
		<section className="custom-scrollbar background-light900_dark800 sticky right-0 top-0 mb-6 flex h-screen max-h-[632px] w-[311px] flex-col justify-between border-l border-light-700 px-4 dark:border-dark-700 max-xl:hidden">
